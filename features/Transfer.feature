...
| GBP    | RON    | -              | IBAN      | RO49AAAA1B31007593840000    | BIC      | BUCUROBUXXX    |>Private               |Private        | -       | -        | -      | -          | -      | -       | -       | -      |
...
| GBP    | SGD    | -              | Bank      | 7171                        | Branch   | 112            | Account               | 1234567       |>Private |Private   | -      | -          | -      | -       | -       | -      |
...
| GBP    | BRL    | -              |>Checking  | Checking                    | Account  | 12345678       |>Brb Banco De Brasilia | Banco Bradesco| Branch  | 001      | Tax    | 79443451115| phone  | 12345678|>Private |Private |
| GBP    | PHP    | -              | Address   | 1 Street                    | Post code| 10001          | City                  | Manilla       |>Ama Bank| Anz Bank | Account| 12345678901| phone  | 12345678|>Private |Private |
| GBP    | NGN    | -              |>Access    | Access	                     | Account  | 0028669292     |>Private               |Private        | -       | -        | -      | -          | -      |  -      | -       | -      |
| GBP    | PKR    | -              |>Al Baraka | Al Baraka                   | Account  | 123456789      |>Private               |Private        | -       | -        | -      | -          | -      |  -      | -       | -      |
| GBP    | MAD    | -              |>Al Barid  | Al Barid                    | Account  | 123456789012345678901234|>Private      | Private       | -       | -        | -      | -          | -      |  -      | -       | -      |