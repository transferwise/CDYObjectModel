...
- (id)initWithTitle:(NSString *)title view:(UIView*)view delegate:(id)delegate cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonsTitles, ...;
