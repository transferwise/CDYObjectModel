...
-(void)configureForInterfaceOrientation:(UIInterfaceOrientation)orientation
{
    ...
    {
        self.scrollViewTopContentOffset.constant = self.recipientType.recipientAddressRequiredValue || [self.recipientTypeFieldCells count] > 4 ? 15.0f : 120.0f;
    ...
    {
        self.scrollViewTopContentOffset.constant = self.recipientType.recipientAddressRequiredValue || [self.recipientTypeFieldCells count] > 4 ? 30.0f : 120.0f;
